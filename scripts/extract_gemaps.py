...
if speed_setting == 0:
    ...
    smile_command = './utils/opensmile/bin/SMILExtract -C ./utils/opensmile/config/gemaps_50ms/eGeMAPSv01a.conf'
else:
    ...
    smile_command = './utils/opensmile/bin/SMILExtract -C ./utils/opensmile/config/gemaps_10ms/eGeMAPSv01a.conf'
